...
import static com.example.project_smart_home.utils.Constants.EXTRA_MESSAGE_MEMBER;
...
public class FaceRegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        member = (Member) getIntent().getSerializableExtra(EXTRA_MESSAGE_MEMBER);

        btnRegisterFace = findViewById(R.id.face_register_btn);
    ...
    public void initCameraAndPreview() {
        ...
        try{
            String mCameraId = "" + CameraCharacteristics.LENS_FACING_BACK;     //전면카메라 사용
    ...
    private CameraDevice.StateCallback deviceStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onError(CameraDevice camera, int error) {
            Toast.makeText(FaceRegisterActivity.this, "카메라를 열지 못했습니다.", Toast.LENGTH_SHORT).show();
        }
    };
    ...
    private CameraCaptureSession.StateCallback mSessionPreviewStateCallback = new CameraCaptureSession.StateCallback() {
        ...
        public void onConfigureFailed(@NonNull CameraCaptureSession session) {
            Toast.makeText(FaceRegisterActivity.this, "카메라 구성 실패", Toast.LENGTH_SHORT).show();
        }
    };
    ...
    private class SaveImageTask extends AsyncTask<Bitmap, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Toast.makeText(FaceRegisterActivity.this, "사진을 저장하였습니다.", Toast.LENGTH_SHORT).show();
        }
    ...
    public static Intent getStartIntent(Context context, Member m){
        Intent intent = new Intent(context, FaceRegisterActivity.class);
        intent.putExtra(EXTRA_MESSAGE_MEMBER, m);
        return intent;
    }
}
